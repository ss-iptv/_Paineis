...
SIMULTANEOUS_SITES = 10  # 5 sites simultâneos
...
def save_data(nhost, user, password, credits, email, registration_date, twofa, whatsapp, telegram):
    base_path = "/home/novidades/_Paineis/results"
    ...
    with open("/home/novidades/_Paineis/results/Sr.Hell@COMBO(U&P).txt", "a") as f:
