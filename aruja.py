...
SIMULTANEOUS_SITES = 15  # 5 sites simultâneos
...
def get_first_combo_file():
    try:
        combo_dir = "/home/araujo/_Paineis/combo"
...
def read_sites():
    try:
        with open("/home/araujo/_Paineis/site.txt", "r") as f:
...
def save_data(nhost, user, password, credits, email, registration_date, twofa, whatsapp, telegram):
    base_path = "/home/araujo/_Paineis/results"
    ...
    with open("/home/araujo/_Paineis/results/Sr.Hell@COMBO(U&P).txt", "a") as f:
